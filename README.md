...
- Miscellaneous/IntegrateXYZ.py - Integrate 2d camera data with Intel RealSense 3D camera data
- Miscellaneous/ply_generation.py - generate pointcloud data
- Miscellaneous/pointcloud_rendering.py - visualize pointclloud data
- Miscellaneous/stereotopy_prediction_trial8.ipynb - application of trained model to specific test case
